    ...
    <div class="wrap_user clear">
        ...
        <div class="right_con">
            <div class="con_user_r clear">
                <h1 class="avatar"><img src="../../images/img_avatar.png"/></h1>
                <ul class="info_user">
                    <li class="name">您好，张三</li>
                    <li><i class="qua1">企业认证</i> <i class="qua2">手机认证</i> </li>
                    <li class="mail">12345678@qq.com</li>
                </ul>
            </div>
            <div class="con_user_r clear">
                <div class="data_u">待确认
                    <p><span class="n1">0</span>对账单</p>
                </div>
                <div class="data_u">待付款
                    <p><span class="n2">0.00</span>元</p>
                </div>
            </div>
            <div class="con_user_r clear">
                <h2>我的订航</h2>
