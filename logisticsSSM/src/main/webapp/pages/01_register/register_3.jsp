...
<div class="content">
    <ul class="step_reg">
        ...
        <li class="step_tri"></li>
        <li class="current"><i>3</i>完善信息</li>
        <li class="step_tri"></li>
        <li><i>4</i>完成</li>
    </ul>
    <div class="bg_register">
        <div class="fl_reg_con">
            <ul class="ul_reg_input">
                ...
                <li><b>账户名:</b>
                    <div class="length_r">admin123</div>
                </li>
                <li><b>电子邮箱:</b>
                    <div class="length_r">12345@qq.com</div>
                </li>
                <li><b class="b2">密码:</b>
                    <div class="length_r">
                        <input type="text" class="input_reg" placeholder="请输入密码" />
                        <p class="tip">密码必须有8哥字符的最小长度并且必须同时包含大写字母
                            和小写字母，以及至少一个非字母字符。</p>
                    </div>
                </li>
                <li></li>
            ...
            <ul class="ul_reg_input">
                ...
                <li><b class="b2">名字:</b>
                    <div class="length_r">
                        <input type="text" class="input_reg" placeholder="请输入名字" />
                    </div>
                </li>
                <li><b class="b2">姓:</b>
                    <div class="length_r">
                        <input type="text" class="input_reg" placeholder="请输入姓" />
                    </div>
                </li>
                <li></li>
            </ul>
        ...
        <div class="fr_reg_con">
            <ul class="ul_reg_input">
                ...
                <li><b class="b2">公司名称:</b>
                    <div class="length_r">
                        <input type="text" class="input_reg" placeholder="请输入公司名称" />
                    </div>
                </li>
                <li><b class="b2">国家:</b>
                    <div class="length_r">
            ...
            <ul class="ul_reg_input">
                ...
                <li></li>
                <li>
                    <div class="protocol_r fL">点击“创建账户”，我同意接受<a class="tcp" href="#" data-dialog="dialog3">网站协议</a>。</div>
                </li>
                <li>
                    <div class="length_r fL"><a class="btn_C" href="register_4.jsp">创建账户</a></div>
                </li>
            </ul>
        </div>
    </div>
