...
*/(function (d, p, q, u) {
	...
	methods = {
		...
		open: function (a, b) {
			...
			0 != a.closeHide && (closeBtnTpl = '<srgall.js id="HCloseBtn" title="\u5173\u95ed" style="width:24px;height:24px;line-height:24px;display:inline-block;cursor:pointer;color:#fff;font-size:24px;text-align:center;position:absolute;top:36px;right:40px;"><span style="width:24px;height:24px;display:inline-block;">\u00d7</span></srgall.js>');
	...
	d.extend({
		showLoading: function (a, b, c) {
			...
			k.stop().append('<div id="HLoading" style="width:' +
				b + "px;height:" + c + "px;line-height:" + c + "px;border-radius:4px;background:rgba(0,0,0,0.6);color:#fff;text-align:center;position:fixed;top:50%;left:50%;margin:" + f + ';">' + a + '<srgall.js style="position:absolute;top:-5px;right:-5px;width:15px;height:15px;line-height:15px;display:inline-block;border-radius:50%;text-align:center;background-color:rgba(0,0,0,0.5);color:#fff;font-size:10px;" href="javascript:;" id="closeBtn">X</srgall.js></div>');
		...
		goTop: function (a, b) {
			...
			k.stop().append('<srgall.js id="HGoTop" href="javascript:;" style="width:40px;height:40px;line-height:40px;border-radius:50%;display:inline-block;text-align:center;background:#333;color:#fff;position:fixed;bottom:' + a + ";right:" + b + ';z-index:100000;">Top</srgall.js>').find("#HGoTop").hide();
			$T = d("#HGoTop");
		...
		dialog: function (a, b, c, f, e) {
			...
			"confirm" === a && (m = '<div id="hDialog-footer" style="padding:10px;border-top:1px solid #ddd;text-align:right;"><srgall.js href="javascript:;" style="padding:5px 10px;display:inline-block;border-radius:3px;background-color:#337ab7;color:#fff;" id="h_ok">\u786e\u5b9a</srgall.js><srgall.js href="javascript:;" style="padding:5px 10px;display:inline-block;border-radius:3px;margin-left:10px;background-color:#eee;color:#333;" id="h_cancel">\u53d6\u6d88</srgall.js></div>');
			...
			d("a.js:contains(\u786e\u5b9a)").on("click", function () {
				void 0 != e && methods.fire.call(this, e)
			});
			d("a.js:contains(\u53d6\u6d88)").on("click", function () {
				d.closeDialog()
			})
		},
