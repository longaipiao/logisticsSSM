...
<div class="content">
    <ul class="step_reg">
        ...
        <li class="current"><i>2</i>验证邮箱</li>
        <li class="step_tri"></li>
        <li><i>3</i>完善信息</li>
        <li class="step_tri"></li>
        <li><i>4</i>完成</li>
    ...
    <div class="bg_register">
        <ul class="ul_reg_input" style="width: 360px;">
            <li>
                <div class="h1_reg">请查收邮件</div>
            </li>
            <li>已发送相关验证信息至1234567@qq.com，<br/>
                请填写验证码或点击验证链接</li>
            <li>
                <input type="text" class="input_reg" placeholder="请输入验证码" />
            </li>
            <li>
                <div class="h5_reg">在查找验证码的同时，请确保不要关掉此窗口。</div>
            </li>
            <li>

                <div class="length_r fL"><a class="btn_C" href="register_3.jsp">下一步</a></div>
